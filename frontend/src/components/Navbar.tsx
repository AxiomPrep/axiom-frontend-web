...
import { Target, BookOpen, GraduationCap, Flame, Info, Menu, X, ArrowRight } from 'lucide-react'
        ...
        >
          <div className="relative">
            ...
            <Image
              ...
              width={44}
              height={44}
              className="relative h-11 w-auto rounded-lg object-contain shadow-lg"
            />
          </div>
        </a>
            ...
            return (
              <li key={link.label}>
                ...
                >
                  {Icon && (
                    <Icon
                      className={`h-3.5 w-3.5 ${link.active ? 'text-amber-400' : 'text-neutral-400 group-hover:text-amber-400'}`}
                    />
                  )}
